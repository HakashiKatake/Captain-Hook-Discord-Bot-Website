  ...
  return (
    <div className={styles.container}>
      ...
      <header className={styles.header}>
        ...
        <ul>
          <li><a href="https://discord.com/api/oauth2/authorize?client_id=756715507306201130&permissions=8&scope=bot" >It's <b>Captain Hook 🏴‍☠️</b> invite me now</a></li>
          <br/>
          <li><a href="https://discord.gg/9Ef8fq5sTA">Join our <b>Support</b> server</a></li>
        </ul>
